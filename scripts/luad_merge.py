...
#Define paths (Update this to your LUAD data folder)
...
#Combine all 8 LUAD samples, use an 'outer' join initially to catch all gene entries
...
#Cleaning Step: Remove genes that are zero across all 8 samples
